...
class Request(object):
    def __init__(self):
        ...
        self.__login = {'Accept': 'application/json',
                      'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiIsImtpZCI6IjI4YTMxOGY3LTAwMDAtYTFlYi03ZmExLTJjNzQzM2M2Y2NhNSJ9..csW1ibtCtBWOhjKuo36L4BvamR8OR-hzfco_MBXs0mE2D0r_nhEeKiEIVGYHQ44qExEKwDno6p4KEGm53WIpdA'}
