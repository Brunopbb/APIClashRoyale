...
class Request(object):
    def __init__(self):
        ...
        self.__login = {'Accept': 'application/json',
                      'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiIsImtpZCI6IjI4YTMxOGY3LTAwMDAtYTFlYi03ZmExLTJjNzQzM2M2Y2NhNSJ9..aH4Su04faUg6wK4SCQnATBuiAZOeZ8neUoFEPqjes1dvB9o1WLbSZtOiONCkPePBuoLPVZEIfXOA5ZJEr0_bFA'}
